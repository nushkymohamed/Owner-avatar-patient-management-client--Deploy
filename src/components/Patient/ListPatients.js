...
function ListPatients() {
  ...
  const columns = [
    { field: '_id', headerName: 'ID', width: 200 },
    {
      ...
      renderCell: (params) => (
        <img
          src={`https://johnsmedicals-patient-management-service.onrender.com/${params.row.photo}`}
  ...
  const handleDelete = (patientId) => {
    ...
    axios
      .delete(
        `https://johnsmedicals-patient-management-service.onrender.com/patients/${patientId}`
      )
      .then(() => {
