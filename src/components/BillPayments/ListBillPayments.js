...
function ListBillPayments() {
  ...
  useEffect(() => {
    axios
      .get('https://johnsmedicals-patient-management-service.onrender.com/payments')
      .then((response) => {
  ...
  const handleDelete = (paymentId) => {
    ...
    axios
      .delete(`https://johnsmedicals-patient-management-service.onrender.com/payments/${paymentId}`)
      .then(() => {
        setBillPayments(
          billPayments.filter(
